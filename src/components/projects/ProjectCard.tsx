...
const ProjectCard: FC<{ project: Project }> = ({ project }) => {
  return (
    <div className="flex flex-col justify-between bg-gradient-to-br from-accent-2 to-light border border-accent-3/30 min-h-[436px] xl:min-h-[400px] rounded-lg overflow-hidden text-dark text-center hover:shadow-[0_0_1.5rem_#b598c7]">
